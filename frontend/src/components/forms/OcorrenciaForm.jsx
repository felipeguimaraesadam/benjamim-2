...
const OcorrenciaForm = ({
  ...
  const validateForm = () => {
    ...
    if (!formData.tipo_ocorrencia)
      newErrors.tipo_ocorrencia = 'Tipo de ocorrência é obrigatório.';
  ...
  const handleSubmit = e => {
    ...
    if (validateForm()) {
      ...
      else if (tipo_ocorrencia === 'falta_justificada')
        tipoBackendValue = 'Falta Justificada';
      else if (tipo_ocorrencia === 'falta_nao_justificada')
        tipoBackendValue = 'Falta não Justificada';
      ...
      const dataToSubmit = {
        ...
        observacao:
          formData.observacao.trim() === '' ? null : formData.observacao,
      };
    ...
    <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
      <div>
        ...
        {errors.funcionario_id && (
          <p className="mt-1 text-sm text-red-600 flex items-center">
            <WarningIcon /> {errors.funcionario_id}
          </p>
        )}
      </div>
      ...
      <div>
        ...
        {errors.tipo_ocorrencia && (
          <p className="mt-1 text-sm text-red-600 flex items-center">
            <WarningIcon /> {errors.tipo_ocorrencia}
          </p>
        )}
      </div>
