...
export const updateObra = (id, obraData) => apiClient.put(`/obras/${id}/`, obraData);
export const deleteObra = (id) => apiClient.delete(`/obras/${id}/`);
export const getObraHistoricoCustos = (obraId) => apiClient.get(`/obras/${obraId}/historico-custos/`);
export const getObraCustosPorCategoria = (obraId) => apiClient.get(`/obras/${obraId}/custos-por-categoria/`);
export const getObraCustosPorMaterial = (obraId) => apiClient.get(`/obras/${obraId}/custos-por-material/`);
export const getItensDisponiveisPorObra = (obraId) => apiClient.get(`/obras/${obraId}/itens-disponiveis/`);

// --- Funcionario Service Functions ---
export const getFuncionarios = (params) => apiClient.get('/funcionarios/', { params });
export const getFuncionarioDetailsById = (id) => apiClient.get(`/funcionarios/${id}/details/`);
export const getFuncionarioById = (id) => apiClient.get(`/funcionarios/${id}/`);
export const createFuncionario = (funcionarioData) => apiClient.post('/funcionarios/', funcionarioData);
export const updateFuncionario = (id, funcionarioData) => apiClient.patch(`/funcionarios/${id}/`, funcionarioData);
...
export const getEquipeDetailsById = (id) => apiClient.get(`/equipes/${id}/details/`);
export const getEquipeById = (id) => apiClient.get(`/equipes/${id}/`);
export const createEquipe = (equipeData) => apiClient.post('/equipes/', equipeData);
export const updateEquipe = (id, equipeData) => apiClient.put(`/equipes/${id}/`, equipeData);
...
export const getMaterialDetailsById = (id) => apiClient.get(`/materiais/${id}/details/`);
export const createMaterial = (materialData) => apiClient.post('/materiais/', materialData);
export const updateMaterial = (id, materialData) => apiClient.put(`/materiais/${id}/`, materialData);
export const deleteMaterial = (id) => apiClient.delete(`/materiais/${id}/`);
export const getMateriaisAlertaEstoqueBaixo = () => apiClient.get('/materiais/alertas-estoque-baixo/');

// --- Report Service Functions ---
export const getRelatorioFinanceiroObra = (params) => apiClient.get('/relatorios/financeiro-obra/', { params });
export const getRelatorioGeralCompras = (params) => apiClient.get('/relatorios/geral-compras/', { params });
export const getRelatorioDesempenhoEquipe = (params) => apiClient.get('/relatorios/desempenho-equipe/', { params });
export const getRelatorioCustoGeral = (params) => apiClient.get('/relatorios/custo-geral/', { params });
export const getRelatorioPagamentoMateriaisPreCheck = (params) => apiClient.get('/relatorios/pagamento-materiais/pre-check/', { params });
export const generateRelatorioPagamentoMateriais = (params) => apiClient.get('/relatorios/pagamento-materiais/generate/', { params });

// --- Despesa Extra Service Functions ---
export const getDespesasExtras = (params) => apiClient.get('/despesas/', { params });
export const getDespesaExtraById = (id) => apiClient.get(`/despesas/${id}/`);
export const createDespesaExtra = (despesaData) => apiClient.post('/despesas/', despesaData);
export const updateDespesaExtra = (id, despesaData) => apiClient.put(`/despesas/${id}/`, despesaData);
...
export const createCompra = (compraData) => apiClient.post('/compras/', compraData);
export const updateCompra = (id, compraData) => apiClient.put(`/compras/${id}/`, compraData);
...
export const getUsosMaterial = (obraId) => apiClient.get('/usomateriais/', { params: { obra_id: obraId } });

// --- Ocorrencia Service Functions ---
export const getOcorrencias = (params) => apiClient.get('/ocorrencias/', { params });
export const createOcorrencia = (ocorrenciaData) => apiClient.post('/ocorrencias/', ocorrenciaData);
export const updateOcorrencia = (id, ocorrenciaData) => apiClient.put(`/ocorrencias/${id}/`, ocorrenciaData);
...
export const uploadFotoObra = (formData) => apiClient.post('/fotosobras/', formData, { headers: { 'Content-Type': 'multipart/form-data' } });
